        ...
        <div class="container">
            <div class="row align-items-center py-5">
                <div class="col-md-8 text-white">
                    <h1>About Us</h1>
                    <p>
                        Crazy Life Tourism offers unforgettable travel experiences, bringing you closer to the world's most exciting destinations. Let us help you create memories that will last a lifetime with our curated tours and personalized services
                    </p>
                </div>
                <div class="col-md-4">
    ...
    <section class="container py-5">
        <div class="row text-center pt-5 pb-3">
            <div class="col-lg-6 m-auto">
                ...
                <p>
                    We provide personalized tour packages, adventure trips, and seamless travel experiences tailored to your unique preferences
                </p>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3 pb-5">
                <div class="h-100 py-5 services-icon-wap shadow">
                    <div class="h1 text-success text-center"><i class="fas fa-shuttle-van"></i></div>
                    <h2 class="h5 mt-4 text-center">Comfortable Ride</h2>
                </div>
            </div>

            <div class="col-md-6 col-lg-3 pb-5">
                <div class="h-100 py-5 services-icon-wap shadow">
                    <div class="h1 text-success text-center"><i class="fas fa-utensils"></i></div>
                    <h2 class="h5 mt-4 text-center">Quality food</h2>
                </div>
            </div>

            <div class="col-md-6 col-lg-3 pb-5">
                <div class="h-100 py-5 services-icon-wap shadow">
                    <div class="h1 text-success text-center"><i class="fa fa-rupee-sign"></i></div>
                    <h2 class="h5 mt-4 text-center">Effective Price</h2>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3 pb-5">
                <div class="h-100 py-5 services-icon-wap shadow">
                    ...
                    <h2 class="h5 mt-4 text-center">Custom Support</h2>
                </div>
            </div>
        </div>
    </section>
