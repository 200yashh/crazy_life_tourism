...
<head>
    <title>{{env('APP_NAME')}} - Contact Page</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="container py-5">
        <div class="row py-5">
            <form class="col-md-9 m-auto contact-us-form" method="post" role="form">
                <div class="row">
                ...
                <div class="row">
                    <div class="col text-end mt-2">
                        <button type="submit" id="send_message_btn" class="btn btn-success btn-lg px-3">Let’s Talk</button>
                    </div>
                </div>
            </form>
        </div>
