...
<head>
    ...
    <!-- google fonts -->
    <!-- Template CSS -->
    <link rel="stylesheet" href="{{ asset('frontend/assets_old/css/style-starter.css') }}">
    <!-- Template CSS -->
...
<body>
    ...
    <section class="w3l-main-slider" id="home">
        <div class="banner-content">
            <div id="demo-1" data-zs-src='["{{ asset('frontend/assets_old/images/banner1.jpg') }}", "{{ asset('frontend/assets_old/images/banner2.jpg') }}","{{ asset('frontend/assets_old/images/banner3.jpg') }}", "{{ asset('frontend/assets_old/images/banner4.jpg') }}"]' data-zs-overlay="dots">
                ...
                <div class="maghny-gd-1 col-lg-6">
                    <div class="maghny-grid">
                        <figure class="effect-lily border-radius  m-0">
                            <img class="img-fluid" src="{{ asset('frontend/assets_old/images/g10.jpg') }}" alt="" />
                            <figcaption>
                                <div>
                ...
                <div class="maghny-gd-1 col-lg-6 mt-lg-0 mt-4">
                    <div class="row">
                        <div class="maghny-gd-1 col-6">
                            <div class="maghny-grid">
                                <figure class="effect-lily border-radius">
                                    <img class="img-fluid" src="{{ asset('frontend/assets_old/images/g9.jpg') }}" alt="" />
                                    <figcaption>
                                        <div>
                                            <h4>3Days, 4 Nights</h4>
                                            <p>From 1220$ </p>
                        ...
                        <div class="maghny-gd-1 col-6">
                            <div class="maghny-grid">
                                <figure class="effect-lily border-radius">
                                    <img class="img-fluid" src="{{ asset('frontend/assets_old/images/g8.jpg') }}" alt="" />
                                    <figcaption>
                                        <div>
                                            <h4>3Days, 4 Nights</h4>
                                            <p>From 1620$ </p>
                        ...
                        <div class="maghny-gd-1 col-6 mt-4">
                            <div class="maghny-grid">
                                <figure class="effect-lily border-radius">
                                    <img class="img-fluid" src="{{ asset('frontend/assets_old/images/g7.jpg') }}" alt="" />
                                    <figcaption>
                                        <div>
                                            <h4>3Days, 4 Nights</h4>
                                            <p>From 1820$ </p>
                        ...
                        <div class="maghny-gd-1 col-6 mt-4">
                            <div class="maghny-grid">
                                <figure class="effect-lily border-radius">
                                    <img class="img-fluid" src="{{ asset('frontend/assets_old/images/g6.jpg') }}" alt="" />
                                    <figcaption>
                                        <div>
                                            <h4>3Days, 4 Nights</h4>
                                            <p>From 1520$ </p>
        ...
        <div class="container py-lg-5">
            ...
            <div class="row mt-5">
                <div class="col-md-9 mx-auto">
                    <img src="{{ asset('frontend/assets_old/images/banner3.jpg') }}" class="img-fluid" alt="">
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Template JavaScript -->
    <script src="{{ asset('frontend/assets_old/js/jquery-3.3.1.min.js') }}"></script>
    <script src="{{ asset('frontend/assets_old/js/theme-change.js') }}"></script>
    <!--/slider-js-->
    <script src="{{ asset('frontend/assets_old/js/jquery.min.js') }}"></script>
    <script src="{{ asset('frontend/assets_old/js/modernizr-2.6.2.min.js') }}"></script>
    <script src="{{ asset('frontend/assets_old/js/jquery.zoomslider.min.js') }}"></script>
    <!--//slider-js-->
    <script src="{{ asset('frontend/assets_old/js/owl.carousel.js') }}"></script>
    ...
    <script src="{{ asset('frontend/assets_old/js/jquery.waypoints.min.js') }}"></script>
    <script src="{{ asset('frontend/assets_old/js/jquery.countup.js') }}"></script>
    <script>
        $('.counter').countUp();
    </script>
    <!-- //stats number counter -->
    ...
    <script src="{{ asset('frontend/assets_old/js/bootstrap.min.js') }}"></script>
            ...
            if (response && response.package_data) {
                if (response.package_data.length > 2) {
                    ...
                    response.package_data.forEach(data => {
                        ...
                        //         <img src="{{ asset('frontend/assets_old/images/g1.jpg') }}" class="img-fluid" alt="">
                        //     </div>`
                        packageHtml +=
