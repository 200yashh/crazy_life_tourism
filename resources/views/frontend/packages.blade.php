...
<head>
    <title>{{env('APP_NAME')}} - Packages Page</title>
    <meta charset="utf-8">
    ...
    <div class="container py-5">
        <div class="row">
            ...
            <div class="">
                ...
                <div class="row">
                    @foreach ($packageData??[] as $pKey => $pVal)                    
                        <div class="col-md-4">
                            <div class="card mb-4 product-wap rounded-0">
                                <div class="card rounded-0">
                                    <img class="card-img rounded-0 img-fluid" src="frontend/assets/img/g{{$pVal['id']??1}}.jpg">
                                    <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                        <ul class="list-unstyled">
                                            <li><a class="btn btn-success text-white mt-2" href="{{url('package-single?PackageId='.$pVal['id']??'')}}"><i class="far fa-eye"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <a href="package-single" class="h3 text-decoration-none">{{$pVal['name']??''}}</a>
                                    ...
                                    <p class="text-center mb-0">
                                        ₹{{!empty($pVal['rate'])? number_format((float) $pVal['rate'], 2, '.', ',') :0.00}}</p>
                                </div>
                            </div>
                        </div>
                    @endforeach
